            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center mb-32">
                    ...
                    <div className="space-y-6">
                        ...
                        <button className="group mt-6 px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center space-x-2">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6 order-1 md:order-2">
                        ...
                        <button className="group mt-6 px-8 py-4 bg-gradient-to-r from-teal-500 to-emerald-600 text-white rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center space-x-2">
