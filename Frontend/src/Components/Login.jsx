                ...
                <div className="w-full max-w-4xl">
                    ...
                    <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/20" style={{ height: '500px' }}>
                        ...
                        <div className="relative flex h-full">
                            {/* Welcome Section - Animated with Slanted Edge */}
                            <div 
                            ...
                            >
                                ...
                                <div className="relative z-10 text-center px-16 max-w-lg">
                                    ...
                                    <p className="text-white/90 text-xs leading-relaxed font-medium">
                                        Discover the world with AI-powered 
                                        <br />
                                        travel planning. Create personalized
                                        <br />
                                        itineraries and make every trip
                                        <br />
                                        unforgettable.
                                    </p>
                                </div>
                            ...
                            {/* Form Section - Animated with Glass Effect and Slanted Edge */}
                            <div 
                                    ...
                                    <div className="space-y-3">
                                        {!isLogin && (
                                            <div className="relative">
                                                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-emerald-500 w-4 h-4" />
                                                <input
                                                    type="text"
                                                    placeholder="First Name"
                                                    value={formData.name}
                                                    onChange={(e) => setFormData({...formData, name: e.target.value})}
                                                    className="w-full pl-9 pr-3 py-2.5 text-sm bg-white/80 backdrop-blur-sm border border-gray-300 rounded-lg focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all text-gray-800 placeholder-gray-400"
                                                />
                                            </div>
                                        )}
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="text"
                                                placeholder={isLogin ? "Username" : "Last Name"}  // CHANGED HERE
                                        ...
                                        <div className="relative">
                                            <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-emerald-500 w-4 h-4" />
                                            <input
                                                type={showPassword ? "text" : "password"}
                                                placeholder="Password"
                                                value={formData.password}
                                                onChange={(e) => setFormData({...formData, password: e.target.value})}
                                                className="w-full pl-9 pr-10 py-2.5 text-sm bg-white/80 backdrop-blur-sm border border-gray-300 rounded-lg focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all text-gray-800 placeholder-gray-400"
                                            />
                                            <button
                                                type="button"
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-2.5 rounded-lg font-semibold text-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
                                        >
                                            {isLogin ? 'Login' : 'Sign up'}
                                        </button>
                                        ...
                                        <button className="w-full py-2.5 border-2 border-gray-300 rounded-lg hover:border-emerald-500 hover:bg-emerald-50/50 transition-all duration-300 flex items-center justify-center space-x-3">
